...
ACTION_HEAD_USE_STATE_CONDITION = int(os.environ.get("ACTION_HEAD_USE_STATE_CONDITION", "0"))
ACTION_HEAD_STOP_GRADIENT = int(os.environ.get("ACTION_HEAD_STOP_GRADIENT", "1"))
ACTION_HEAD_VIDEO_HIDDEN_PRED_ONLY = int(os.environ.get("ACTION_HEAD_VIDEO_HIDDEN_PRED_ONLY", "0"))
...
PRECOMPUTED_LATENT_FSDP_RECTIFIED_FLOW_CONFIG = dict(
    ...
    model=L(PrecomputedLatentVideo2WorldModel)(
        ...
        action_head_noise_beta_alpha=ACTION_HEAD_NOISE_BETA_ALPHA,
        action_head_noise_beta_beta=ACTION_HEAD_NOISE_BETA_BETA,
        action_head_noise_beta_s=ACTION_HEAD_NOISE_BETA_S,
        action_head_stop_gradient=bool(ACTION_HEAD_STOP_GRADIENT),
        action_head_video_hidden_pred_only=bool(ACTION_HEAD_VIDEO_HIDDEN_PRED_ONLY),
